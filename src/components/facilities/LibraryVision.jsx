        ...
        ">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-6 items-center">
            ...
            <div>
              ...
              <span className="text-[#002147] text-xl md:text-2xl text-lg font-medium">
                Library
              </span>

              <h5 className="text-[34px] md:text-[48px] lg:text-[60px] sm:text-[30px] text-[26px] leading-none text-[#002147] font-medium mb-3">
              ...
              <h6 className="text-[22px] md:text-[28px] lg:text-[32px] sm:text-[22px] text-[#002147] mt-4 font-medium">
