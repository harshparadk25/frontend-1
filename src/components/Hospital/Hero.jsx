...
import heroImage from "../../assets/Images/hero.jpg"; // your hero image

export default function Hero() {
  const [showVideo, setShowVideo] = useState(false);

  // ✅ STATIC DATA (from image)
  const description = "Serving Excellence in Global Hospitality Education";
  const ctaText = "Explore Now";
  const videoUrl = ""; // add youtube embed link if needed
